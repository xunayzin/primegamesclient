...
export const EditGame = styled.div`
  ${({ theme }) => css`
...
export const EditGameImage = styled.img`
  ${() => css`
    width: 130px;
  `}
`;

export const EditGameDetails = styled.div`
  ${() => css`
    display: flex;
    flex-direction: column;
...
export const EditGameDetailsName = styled.h3`
  ${({ theme }) => css`
...
export const EditGameDetailsGenre = styled.strong`
  ${({ theme }) => css`
    ${theme.mixins.bodyStyle()};
...
export const EditGameDetailsDescription = styled.small`
  ${({ theme }) => css`
    ${theme.mixins.bodyStyle()};
    font-size: 12px;
    text-align: center;
...
export const EditGameAction = styled.div`
  ${({ theme }) => css`
    width: 100%;
    display: flex;

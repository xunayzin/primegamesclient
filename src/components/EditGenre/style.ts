...
export const EditGenreImage = styled.img`
  ${() => css`
    width: 130px;
  `}
`;

export const EditGenreDetails = styled.div`
  ${() => css`
    display: flex;
    flex-direction: column;
...
export const EditGenreDetailsName = styled.h1`
  ${({ theme }) => css`
...
export const EditGenreAction = styled.button`
  ${({ theme }) => css`
    width: 100%;
    display: flex;
    justify-content: center;
